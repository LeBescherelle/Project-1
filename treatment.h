...
/**
	...
	*@brief Tri le tableau de données soit par ordre croissant
...
/**
	...
	*
	*@param tab Tableau ou effectuer la recherche.
	*@param size Taille du tableau.
	*@param time Critère de temps ou effectuer la recherche.
	*@return Data_Line - Structure de la ligne trouvé.
*/
...
/**
	...
	*@brief Calcule la moyenne de pouls dans une intervalle de temps.
	*
...
/**
	...
	*@brief Affiche le maximum et minimum de pouls enregistrés.
	*
	*@param tab Tableau de données.
	*@param size Taille du tableau de données.
*/
